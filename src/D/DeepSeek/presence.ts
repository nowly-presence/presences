...
const settings = Presence.Settings({
  showPrivateChats: {
    ...
    description: {
      "en-US": "When enabled, incognito DeepSeek chats can show their title on Discord. Off by default: Discord only shows that you are using DeepSeek.",
      "fr-FR": "Lorsque cette option est activée, les chats incognito DeepSeek peuvent afficher leur titre sur Discord. Désactivé par défaut : Discord indique seulement que vous utilisez DeepSeek.",
      "es-ES": "Si está activada, los chats incógnito de DeepSeek pueden mostrar su título en Discord. Desactivada por defecto: Discord solo muestra que estás usando DeepSeek.",
    },
  },
  ...
  showBrowsing: {
    ...
    description: {
      "en-US": "Show activity while you browse DeepSeek outside a chat.",
      "fr-FR": "Affiche l'activité lorsque vous parcourez DeepSeek hors d'un chat.",
      "es-ES": "Muestra actividad al explorar DeepSeek fuera de un chat.",
    },
  },
  showButtons: {
    type: "boolean",
...
presence.on("UpdateData", async (ctx) => {
  ...
  if (page.kind === "chat") {
    ...
    const data: PresenceData = {
      details: title ? presence.formatString(strings.chatting, { title }) : strings.usingDeepSeek,
  ...
  await presence.setActivity({
    details: strings.browsingDeepSeek,
    largeImageKey: Assets.Logo,
    largeImageText: "DeepSeek",
    type: PresenceType.Playing,
  })
